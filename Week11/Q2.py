...
#  COMP2152 — Andrea Salswach Lopez
# ============================================================
#
...
class PasswordChecker:
    ...
    def __init__(self):
        self.common_passwords = ["admin", "password", "123456", "root", "letmein", "welcome"]
        self.history = []
    ...
    def evaluate(self, password):
        if self.check_common(password) is True:
            result = "WEAL (common password)"
        else:
